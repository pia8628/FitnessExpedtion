...
TBD: Define map card visuals and imagery scope for the UI.
...
### Requirement: Map card aspect ratio and size（比例與尺寸）
The map card image SHALL use a 16:9 aspect ratio.
地圖圖卡比例固定為 16:9。

#### Scenario: Supported sizes（建議尺寸）
- **WHEN** preparing map card assets
- **THEN** recommended sizes include 1280x720, 960x540, or 1920x1080
